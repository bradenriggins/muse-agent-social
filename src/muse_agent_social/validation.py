...
def _schemas_dir() -> Path:
    ...
    # Schemas ship inside the package (src/muse_agent_social/schemas/) so
    # they resolve identically from a checkout, a wheel, or an sdist.
    import importlib.resources

    return Path(
        str(importlib.resources.files("muse_agent_social.schemas"))
    )
